defmodule FranklinWeb.ConnCase do
  @moduledoc """
  ...
  by setting `use FranklinWeb.ConnCase, async: true`, although
  ...
  def register_and_log_in_user(%{conn: conn}) do
    user = Franklin.AccountsFixtures.user_fixture()
  ...
  def log_in_user(conn, user) do
    token = Franklin.Accounts.generate_user_session_token(user)
