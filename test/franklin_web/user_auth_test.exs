defmodule FranklinWeb.UserAuthTest do
  use FranklinWeb.ConnCase, async: true

  alias Phoenix.LiveView
  alias Franklin.Accounts
  alias FranklinWeb.UserAuth
  ...
  setup %{conn: conn} do
    conn =
      conn
      |> Map.replace!(:secret_key_base, FranklinWeb.Endpoint.config(:secret_key_base))
      |> init_test_session(%{})
  ...
  describe "logout_user/1" do
    ...
    test "broadcasts to the given live_socket_id", %{conn: conn} do
      ...
      FranklinWeb.Endpoint.subscribe(live_socket_id)
