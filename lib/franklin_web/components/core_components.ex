defmodule FranklinWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(FranklinWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(FranklinWeb.Gettext, "errors", msg, opts)
    end
  end
