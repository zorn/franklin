defmodule FranklinWeb.Router do
  ...
  scope "/", FranklinWeb do
    ...
    live_session :redirect_if_user_is_authenticated,
      on_mount: [{FranklinWeb.UserAuth, :redirect_if_user_is_authenticated}] do
  ...
  scope "/", FranklinWeb do
    ...
    live_session :require_authenticated_user,
      on_mount: [{FranklinWeb.UserAuth, :ensure_authenticated}] do
  ...
  scope "/", FranklinWeb do
    ...
    live_session :current_user,
      on_mount: [{FranklinWeb.UserAuth, :mount_current_user}] do
